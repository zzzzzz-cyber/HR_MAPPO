...
def run(InfdexofResult):
    ...
    Benchmarks_modes = ["offloadtimefirst_MADDPG"] #["deadline_divide2_size_first_MADDPG", "offloadtimefirst_MADDPG", "MADDPG", "mindeadlinefirst_MADDPG",  "maxdeadlinefirst_MADDPG",  "minsizefirst_MADDPG", "maxsizefirst_MADDPG"]
...
if __name__ == "__main__":
    InfdexofResult = "1" # set run runnumber for indexing results,
    run(InfdexofResult) 
