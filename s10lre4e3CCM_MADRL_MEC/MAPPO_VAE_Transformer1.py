...
PATH = "./model/HYASP_RMAPPO_u/"


class MAPPO_VAE_Trans_u(object):
    ...
    def evaluate(self, EVAL_EPISODES):
        ...
        for i in range(EVAL_EPISODES):
            ...
            if i == EVAL_EPISODES-1 and done:
                ...
                savetxt('./CSV/results/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', arrayresults)
                savetxt('./CSV/loss/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', arrayloss)
                savetxt('./CSV/Server_constraints/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', arrayserver)
                savetxt('./CSV/Energy_constraints/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', arrayenergy)
                savetxt('./CSV/Time_constraints/MAPPO_VAE_Trans_u_' + str(self.InfdexofResult)+'.csv', arraytime)

                savetxt('./CSV/result_EC/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', result_EC)
                savetxt('./CSV/result_EX/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', result_EX)
                savetxt('./CSV/result_LT/MAPPO_VAE_Trans_u_'+str(self.InfdexofResult)+'.csv', result_LT)
                savetxt('./CSV/result_LX/MAPPO_VAE_Trans_u_' + str(self.InfdexofResult)+'.csv', result_LX)
    ...
    def evaluateAtTraining(self, EVAL_EPISODES):
        ...
        savetxt('./CSV/AtTraining/MAPPO_VAE_Trans_u_' + self.InfdexofResult+'.csv', arrayresults)
