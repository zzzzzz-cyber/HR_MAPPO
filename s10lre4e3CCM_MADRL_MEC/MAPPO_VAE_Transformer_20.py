...
PATH = "./model/HYASP_RMAPPO_20/"


class MAPPO_VAE_Trans_20(object):
    def __init__(self, InfdexofResult, env, env_eval, n_agents, state_dim, action_dim, action_lower_bound, action_higher_bound,
                 ...
                 actor_output_activation=torch.tanh, actor_lr=1e-5, critic_lr=1e-3,
    ...
    def evaluate(self, EVAL_EPISODES):
        ...
        for i in range(EVAL_EPISODES):
            ...
            if i == EVAL_EPISODES-1 and done:
                ...
                savetxt('./CSV/results/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', arrayresults)
                savetxt('./CSV/loss/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', arrayloss)
                savetxt('./CSV/Server_constraints/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', arrayserver)
                savetxt('./CSV/Energy_constraints/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', arrayenergy)
                savetxt('./CSV/Time_constraints/MAPPO_VAE_Trans_20_' + str(self.InfdexofResult)+'.csv', arraytime)

                savetxt('./CSV/result_EC/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', result_EC)
                savetxt('./CSV/result_EX/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', result_EX)
                savetxt('./CSV/result_LT/MAPPO_VAE_Trans_20_'+str(self.InfdexofResult)+'.csv', result_LT)
                savetxt('./CSV/result_LX/MAPPO_VAE_Trans_20_' + str(self.InfdexofResult)+'.csv', result_LX)
    ...
    def evaluateAtTraining(self, EVAL_EPISODES):
        ...
        savetxt('./CSV/AtTraining/MAPPO_VAE_Trans_20_' + self.InfdexofResult+'.csv', arrayresults)
