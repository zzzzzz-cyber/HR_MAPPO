...
class PER_CMDRL(object):
    ...
    def append_tree_sample(self, states, actor_actions, critic_actions, rewards, next_states, dones):
        ...
        current_value1 = self.critics1[0](states_var, actor_actions_var).detach()
        current_value2 = self.critics2[0](states_var, actor_actions_var).detach()
    ...
    def train(self):
        ...
        next_value = prob_next_action * (min_q_value - self.log_alpha.exp() * log_prob_next_action)
        target_value = self.reward_scale * rewards_var + self.reward_gamma * next_value
